...
<!--列表-->
  <div class="menu_style">
    ...
    <li ><em></em><a href="showguanli.jsp">订单专区</a></li>
    <li class="on"><em></em><a href="addproduct.jsp">店铺上新</a></li>
   </ul>
  </div>
</div>
<%
...
%>
<form action="<%=request.getContextPath() %>/addproduct.product" id="sh" name="sh" method="post" enctype="multipart/form-data"> 
    ...
    <div class="content_style">
     ...
     <table cellpadding="0" cellspacing="0" width="100%">
      <tr>
       ...
       <tr><td class="label">商品名称:</td><td><input id="pname" name="pname" type="text"  class="addtext"  style=" width:500px;"/></td></tr>
       <tr><td class="label">设置商品分类：</td><td> 
       <select id="pclass"  name="pclass" size="1">
        <option value="饮料">饮料</option>
        <option value="食品">食品</option>
      </select>
      </td></tr>
      
       <tr><td class="label">商品销售价格：</td><td><input id="price" name="price" type="text"  class="addtext" style=" width:200px;"/></td></tr>
...
<!--                     	<input id="agreement_tips" name="" type="text" class="auto_tips"  style=" width:100px; float:left"/> -->
       ...
       <tr><td class="label">商品概要介绍：</td><td><textarea id="pxinxi" name="pxinxi" cols="" rows="" placeholder="商品的概要介绍。该介绍将出现在商品名称下方。" class="textarea"></textarea></td></tr>
...
　　　　　　　　<a href="javascript:void(0)" class="link-btn" >选择文件(.jpg)</a> (.jpg)
　　　　　　</div> 
　　　　</div> 
     ...
     <a href="javascript:document:sh.submit();" class="Next_btn" >提交商品资料</a>
     </form>
     </div>
    </div>
  </div>
