...
<div class="user_style clearfix">
 ...
 <div class="left_style">
     ...
     <div class="user_portrait">
      ...
      <div class="user_name">
       <p><span class="name"><%=user.getUsername() %></span><a href="#"></a></p>
 ...
 <div class="right_style">
    ...
    <div class="Notice"><span>系统最新公告:</span>为了更好地服务于【每日鲜】的会员朋友及读者 发表意见。</div>
     <div class="user_info">
      <ul class="">
       <li class="Balance"><a href="#"><img src="images/user_img_05.png" /><h4>余额：<%=user.getMoney() %></h4></a></li>
       <li class="Order_form"><a href="#"><img src="images/user_img_04.png" /><h4>订单：<%=10 %></h4></a></li>
